...
vex::brain Brain;
vex::motor Lift(vex::PORT4, vex::gearSetting::ratio36_1, true);
...
vex::motor LeftFrontMotor (vex::PORT14, vex::gearSetting::ratio18_1, false);
...
vex::inertial Inertial(vex::PORT5);
