...
using namespace vex;
vex::brain Brain;
vex::motor Lift (vex::PORT15, vex::gearSetting::ratio36_1,true);
vex::motor Tilt (vex::PORT3, vex::gearSetting::ratio36_1,false);
vex::motor LeftIntake (vex::PORT12, vex::gearSetting::ratio18_1,true);
...
vex::inertial Inertial(vex::PORT9);
